...
<div class="mClubMainImg">
    <div class="heading">
        ...
        <div class="textFirstPhoto">
            <p>
            <div class="header">Вітаємо вас, дорогі мами!</div><br/> Приєднуйтесь до програми "Мама-клуб"<br/> мережі магазинів «Лотос», та здійснюйте<br/> покупки для ваших малюків з відчутною економією.
            </p>
        </div>

        <div class="textSecondPhoto">
            <p>
                В роздрібних магазинах картка "Мама-клубу" надає знижку 5% на інші товари.<br/> Картка є власністю мережі магазинів "Лотос" та може бути вилучена за рішенням організаторів програми.<br/> Термін дії картки необмежений.<br/> Картка дійсна в усіх магазинах мережі "Лотос" та на сайті lotos24.com.ua.
            </p>
        </div>
