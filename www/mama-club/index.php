...
?><div class="mama_club_decoration">
 ...
 <img width="371" src="/local/templates/dresscodeV2/artorg/images/mama_club_banner.png" height="226"><br>
    ...
    <p>Приобретите карту мама-клуба и активируйте ее на сайте lotos.zp.ua</p>
    ...
    <p>Внимание! Активировать карту или узнать подробности вы можете на нашем сайте lotos.zp.ua, в call-центр 0800300244, а также – у продавцов-консультантов сети магазинов «Лотос»</p>
