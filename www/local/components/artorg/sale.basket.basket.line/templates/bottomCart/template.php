...
<div class="item">
    ...
    <span class="freeDelivery<?if($arResult["ART_TOTAL_PRICE"]<=0):?> mark<?endif;?>"><?if($arResult["ART_TOTAL_PRICE"]>0):?>До бесплатной доставки осталось <span class="mark"><?=$arResult["ART_TOTAL_PRICE_STR"];?></span><?else:?>Доставка бесплатно<?;endif;?></span>
</div>
<?$frame->end();?>