...
$MESS['SOA_ORDER_SUC'] = "Спасибо. Ваш заказ <b>№#ORDER_ID#</b> успешно создан.";
$MESS['SOA_PAYMENT_SUC'] = "Номер вашей оплаты: <b>№#PAYMENT_ID#</b>";
$MESS['SOA_ORDER_SUC1'] = "Наш менеджер свяжется с Вами в ближайшее время для уточнения деталей заказа. <br/>Уточнить информацию о вашем заказе вы можете в <a href=\"#LINK#\">личном кабинете</a> или по телефонам: +380(61)214-99-54, +380(67)620-22-44.";
