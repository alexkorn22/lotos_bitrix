		...
		<div class="container" id="fastBuyOpenContainer">
			<div class="column">
				...
				<form action="<?=SITE_DIR?>callback/" id="fastBuyForm" method="GET">
					...
					<input name="act" type="hidden" id="fastBuyFormAct" value="fastBackCart">
					...
					<div class="formLine"><a href="#" id="fastBuyFormSubmit"><i class="fa fa-shopping-bag new-bag" aria-hidden="true"></i> Купить в один клик</a></div>
				</form>
			</div>
		</div>
